...
const Footer = () => {
  return (
    <footer className="mt-auto w-full py-6 px-4 border-t border-border/50 backdrop-blur-md bg-background/80">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-sm text-white/70">
              The ultimate platform for esports enthusiasts to discover players, 
              build teams, and compete in their favorite games.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li><Link to="/discover" className="hover:text-white transition-colors">Discover Players</Link></li>
        ...
        <div className="mt-8 pt-6 border-t border-border/50 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-white/50">© 2025 Nexus Arena. All rights reserved.</p>
